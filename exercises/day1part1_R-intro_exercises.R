...
write_csv(gapminder07, path="data/gapminder07.csv")
...
plot(gapminder07$lifeExp ~ gapminder07$gdpPercap,
     main = 'Scatter Plot of Life Expectancy & GDP',
...
# Adds a trend line to the scatter plot
abline(reg = lm(gapminder07$lifeExp ~ gapminder07$gdpPercap))
